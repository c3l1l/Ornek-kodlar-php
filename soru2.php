...
<tr><td align="center"><img src="resimler/h4ck3rtyp3r.jpg" width="500px" height="300px"></td></tr>
<tr><td>Merhaba hacker.</td></tr>
<tr><td>
Elliot ilk web sitesini yapacak.Bunun için dizide de anlattığı basit bir yöntem kullanıyor.Bu yöntemi kullanarak flag'i bulunuz.</td></tr>
<td><td><form action="soru2.php" method="POST" name="form1">
<tr><td>
	Cevabı giriniz.<input type="textbox" name="cevap_2" />
